...
const PrivacyPolicy: NextPage = () => {
  return (
    <div>
      <Head>
        <title>Политика конфиденциальности | Literoad</title>
      </Head>
      <section className="lr-container">
        ...
        <p>
          ...
          которую сайт Literoad, (далее – Сервис) расположенный на доменном
          имени literoad.ru (а также его субдоменах), может получить о
          Пользователе во время использования сайта literoad.ru (а также его
          субдоменов), его программ и его продуктов.
        </p>
        <h3 className="text-center">1. Определение терминов</h3>
        <p>
          1.1 В настоящей Политике конфиденциальности используются следующие
          термины:
        </p>
        <p>
          1.1.1. «Администрация сайта» (далее – Администрация) – уполномоченные
          сотрудники на управление сайтом Literoad, действующие от имени ИП
          Пуханов В.С., которые организуют и (или) осуществляют обработку
        ...
        <p>
          1.1.5. «Сайт Literoad» - это совокупность связанных между собой
          веб-страниц, размещенных в сети Интернет по уникальному адресу (URL):
          literoad.ru, а также его субдоменах.
        </p>
        <p>
          1.1.6. «Субдомены» - это страницы или совокупность страниц,
          расположенные на доменах третьего уровня, принадлежащие сайту
          Literoad, а также другие временные страницы, внизу который указана
          контактная информация Администрации
        </p>
        <p>
          1.1.5. «Пользователь сайта Literoad » (далее Пользователь) – лицо,
          имеющее доступ к сайту Literoad, посредством сети Интернет и
          использующее информацию, материалы и продукты сайта Literoad.
        </p>
        <p>
        ...
        <p>
          ...
          через который Пользователь получает доступ на Сервис.
        </p>
        <p>
        ...
        <p>
          2.1. Использование сайта Literoad Пользователем означает согласие с
        ...
        <p>
          ...
          Пользователь должен прекратить использование сайта Literoad.
        </p>
        <p>
          2.3. Настоящая Политика конфиденциальности применяется к сайту
          Literoad. Сервис не контролирует и не несет ответственность за сайты
          третьих лиц, на которые Пользователь может перейти по ссылкам,
          доступным на сайте Literoad.
        </p>
        <p>
          2.4. Администрация не проверяет достоверность персональных данных,
          предоставляемых Пользователем.
        </p>
        <h3 className="text-center">3. Предмет политики конфиденциальности</h3>
        <p>
          ...
          Literoad, при подписке на информационную e-mail рассылку или при
          оформлении заказа.
        </p>
        <p>
          ...
          заполнения форм на сайте Literoad и включает в себя адрес электронной
          почты пользователя
        </p>
        <p>
          3.3. Сервис защищает Данные, которые автоматически передаются при
          посещении страниц: IP адрес; информация из cookies; информация о
          браузере; время доступа; реферер (адрес предыдущей страницы).
        </p>
        <p>
        ...
        <p>
          3.3.2. Сервис осуществляет сбор статистики об IP-адресах своих
        ...
        <p>
          ...
          Literoad, если Пользователь дал согласие на создание учетной записи.
        </p>
        ...
        <p>
          ...
          при возникновении проблем, связанных с использованием сайта Literoad.
        </p>
        <p>
        ...
        <p>
          5.2. Пользователь соглашается с тем, что Администрация вправе
          передавать персональные данные третьим лицам, в частности, курьерским
          службам, организациями почтовой связи (в том числе электронной),
          операторам электросвязи, исключительно в целях выполнения заказа
          Пользователя, оформленного на сайте Literoad, включая доставку Товара,
        ...
        <h3 className="text-center">6. Права и обязанности сторон</h3>
        <p>6.1. Пользователь вправе:</p>
        <p>
          6.1.1. Принимать свободное решение о предоставлении своих персональных
          данных, необходимых для использования сайта Literoad, и давать
        ...
        <h3 className="text-center">7. Ответственность сторон</h3>
        <p>
        ...
        <p>
          ...
          которой он может иметь доступ как к части сайта Literoad, несет лицо,
          предоставившее такую информацию.
        </p>
        <p>
          7.5. Пользователь соглашается, что информация, предоставленная ему как
          часть сайта Literoad, может являться объектом интеллектуальной
          ...
          информацию на сайте Literoad. Пользователь не вправе вносить
          ...
          такого Содержания (полностью или в части), за исключением случаев,
          когда такие действия были письменно прямо разрешены собственниками
          такого Содержания в соответствии с условиями отдельного соглашения.
        </p>
        <p>
          7.6. В отношение текстовых материалов (статей, публикаций, находящихся
          в свободном публичном доступе на сайте Literoad) допускается их
        ...
        <p>
          ...
          иных коммуникационных данных, содержащихся на сайте Literoad или
        ...
        <p>
          ...
          размещенную пользователем на сайте Literoad, включая, но не
          ограничиваясь: информацию, защищенную авторским правом, без прямого
          согласия владельца авторского права.
        </p>
        <h3 className="text-center">8. Разрешение споров</h3>
        <p>
        ...
        <h3 className="text-center">9. Дополнительные условия</h3>
        <p>
        ...
        <p>
          ...
          размещения на сайте Literoad, если иное не предусмотрено новой
          редакцией Политики конфиденциальности.
        </p>
        <p>
          9.3. Все предложения или вопросы касательно настоящей Политики
          конфиденциальности следует сообщать по адресу: support@literoad.ru
        </p>
        <p>
        ...
        <p>Обновлено: 05 Апреля 2022 года</p>
      </section>
    </div>
  );
};
